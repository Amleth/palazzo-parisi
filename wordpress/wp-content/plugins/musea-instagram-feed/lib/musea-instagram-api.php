...
include 'musea-instagram-helper.php';

/**
 * Class MuseaInstagramApi
 */
class MuseaInstagramApi {
	...
	const INSTAGRAM_CODE = 'musea_instagram_code';
	const INSTAGRAM_USER_ID = 'musea_instagram_user_id';
	const INSTAGRAM_TOKEN = 'musea_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'musea_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'musea_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'musea_facebook_code';
	const FACEBOOK_TOKEN = 'musea_facebook_access_token';

	const CONNECTION_TYPE = 'musea_connection_type';
	...
	public function __construct() {
		...
		$this->helper = new MuseaInstagramHelper();
	}

	/**
	 * @return MuseaInstagramApi
	 */
	 ...
	 *
	 * @see MuseaInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see MuseaInstagramApi::instagramExchangeCodeForToken()
	 */
