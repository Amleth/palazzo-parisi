...
/**
 * Class MuseaInstagramHelper
 */
class MuseaInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines musea_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image ) {
		...
		$imageAtts = apply_filters( 'musea_instagram_image_atts',
			array(
