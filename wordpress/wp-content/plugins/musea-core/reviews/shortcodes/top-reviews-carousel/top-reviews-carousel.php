...
namespace MuseaCore\CPT\Shortcodes\TopReviewsCarousel;

use MuseaCore\Lib\ShortcodeInterface;

class TopReviewsCarousel implements ShortcodeInterface {
	private $base;
	
	public function __construct() {
		$this->base = 'musea_core_top_reviews_carousel';
	...
	public function vcMap() {
		$criteria_ratings = musea_core_rating_criteria_for_vc();
		
		vc_map(
			array(
				'name'                      => esc_html__( 'Top Reviews Carousel', 'musea-core' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					...
					array(
						...
						'heading'     => esc_html__( 'Number of Reviews', 'musea-core' ),
						'description' => esc_html__( 'Leave empty for all', 'musea-core' )
					),
					array(
						'type'        => 'dropdown',
						'param_name'  => 'review_criteria',
						'heading'     => esc_html__( 'Order by Review Criteria', 'musea-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		return musea_core_get_module_shortcode_template_part( 'reviews', 'top-reviews-carousel', 'top-reviews-carousel', '', $params );
	}
