<?php
namespace MuseaCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Call To Action', 'musea-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'musea-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'musea-core' ),
							'value'      => array(
								esc_html__( '80/20', 'musea-core' ) => '80',
								esc_html__( '75/25', 'musea-core' ) => '75',
								esc_html__( '66/33', 'musea-core' ) => '66',
								esc_html__( '50/50', 'musea-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
						...
						array(
							...
							'heading'     => esc_html__( 'Button Type', 'musea-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Button Size', 'musea-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Background Color', 'musea-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'musea-core' ),
							'group'      => esc_html__( 'Button Style', 'musea-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_border_color',
							'heading'    => esc_html__( 'Button Border Color', 'musea-core' ),
							'group'      => esc_html__( 'Button Style', 'musea-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_border_color',
							'heading'    => esc_html__( 'Button Hover Border Color', 'musea-core' ),
							'group'      => esc_html__( 'Button Style', 'musea-core' )
						),
						array(
							'type'       => 'textarea_html',
							'param_name' => 'content',
							'heading'    => esc_html__( 'Content', 'musea-core' ),
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'musea-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = musea_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . musea_elated_filter_px( $params['button_top_margin'] ) . 'px';
		}
