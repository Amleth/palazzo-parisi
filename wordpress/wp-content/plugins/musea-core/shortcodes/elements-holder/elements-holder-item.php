...
class ElementsHolderItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Elements Holder Item', 'musea-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Padding', 'musea-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'musea-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'horizontal_alignment',
							'heading'    => esc_html__( 'Horizontal Alignment', 'musea-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Vertical Alignment', 'musea-core' ),
							'value'      => array(
								esc_html__( 'Middle', 'musea-core' ) => 'middle',
								esc_html__( 'Top', 'musea-core' )    => 'top',
								esc_html__( 'Bottom', 'musea-core' ) => 'bottom'
							)
						),
						array(
							'type'       => 'dropdown',
							...
							'value'      => array(
								esc_html__( 'Default (No Animation)', 'musea-core' )   => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 1400px-1600px', 'musea-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'musea-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'musea-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'item_padding_1025_1399',
							'heading'     => esc_html__( 'Padding on screen size between 1025px-1399px', 'musea-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'musea-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'musea-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 768px-1024px', 'musea-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'musea-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'musea-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 680px-768px', 'musea-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'musea-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'musea-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size bellow 680px', 'musea-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'musea-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'musea-core' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = musea_core_get_shortcode_module_template_part( 'templates/elements-holder-item-template', 'elements-holder', '', $params );
