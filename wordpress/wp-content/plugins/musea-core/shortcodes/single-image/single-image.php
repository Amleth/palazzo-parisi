<?php
namespace MuseaCore\CPT\Shortcodes\SingleImage;
...
class SingleImage implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Single Image', 'musea-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Moving on Hover', 'musea-core' )  => 'moving'
							)
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Image Animation', 'musea-core' ),
							'value'      => array(
								esc_html__( 'None', 'musea-core' )          => '',
	...
	public function render( $atts, $content = null ) {
		...
		$html = musea_core_get_shortcode_module_template_part( 'templates/single-image', 'single-image', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['image_animation'] ) ? 'eltdf-image-animation-' . $params['image_animation'] : '';
