<?php
namespace MuseaCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'musea-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'musea-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'musea-core' ) => 'grid',
								esc_html__( 'Masonry', 'musea-core' )    => 'masonry',
								esc_html__( 'Slider', 'musea-core' )     => 'slider',
								esc_html__( 'Carousel', 'musea-core' )   => 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							'type'        => 'attach_images',
							'param_name'  => 'images',
							'heading'     => esc_html__( 'Images', 'musea-core' ),
							'description' => esc_html__( 'Select images from media library', 'musea-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'image_size',
							'heading'     => esc_html__( 'Image Size', 'musea-core' ),
							'description' => esc_html__( 'Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "full" size', 'musea-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Custom Links', 'musea-core' ),
							'description' => esc_html__( 'Delimit links by comma', 'musea-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'musea-core' ),
							'value'       => array(
								...
								esc_html__( 'Six', 'musea-core' )   => '6'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'musea-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_loop',
							'heading'     => esc_html__( 'Enable Slider Loop', 'musea-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'musea-core' ),
							'description' => esc_html__( 'Default value is 5000 (ms)', 'musea-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'musea-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Slide Animation Duration', 'musea-core' ),
							'description' => esc_html__( 'Speed of slide animation in milliseconds. Default value is 600.', 'musea-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'musea-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'musea-core' ),
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'musea-core' ),
							'value'       => array_flip( musea_elated_get_yes_no_select_array( false ) ),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'musea-core' ),
							'value'       => array_flip( musea_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'musea-core' )
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'musea-core' ),
							'value'       => array_flip( musea_elated_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'musea-core' )
	...
	public function render( $atts, $content = null ) {
		...
		$html = musea_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
