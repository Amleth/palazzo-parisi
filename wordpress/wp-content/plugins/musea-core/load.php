...
//load import
require_once 'import/musea-import.php';
require_once 'import/musea-import-functions.php';

//load export
require_once 'backup/functions.php';

//load reviews
if ( file_exists( MUSEA_CORE_ABS_PATH . '/like' ) ) {
	require_once 'like/load.php';
}

//load reviews
if ( file_exists( MUSEA_CORE_ABS_PATH . '/reviews' ) ) {
