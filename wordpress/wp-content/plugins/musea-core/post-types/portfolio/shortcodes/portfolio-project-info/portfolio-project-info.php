...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'musea-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'musea-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'If you left this field empty then project ID will be of the current page', 'musea-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'project_info_type',
							'heading'     => esc_html__( 'Project Info Type', 'musea-core' ),
							'value'       => array(
								esc_html__( 'Title', 'musea-core' )          => 'title',
								esc_html__( 'Category', 'musea-core' )       => 'category',
								esc_html__( 'Tag', 'musea-core' )            => 'tag',
								esc_html__( 'Author', 'musea-core' )         => 'author',
								esc_html__( 'Date', 'musea-core' )           => 'date',
								esc_html__( 'Featured Image', 'musea-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'musea-core' ),
							'value'       => array_flip( musea_elated_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'musea-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'musea-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'musea-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'musea-core' ),
							'value'      => array_flip( musea_elated_get_title_tag( true, array( 'p' => 'p' ) ) ),
