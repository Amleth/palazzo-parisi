...
if(is_array($categories) && count($categories)) : ?>
    <div class="eltdf-pvl-info-item eltdf-pvl-categories">
        <?php echo musea_core_get_cpt_shortcode_module_template_part('portfolio', 'portfolio-vertical-loop', 'parts/info-title', 'standard', array( 'title' => esc_attr__('Category:', 'musea-core') )); ?>
