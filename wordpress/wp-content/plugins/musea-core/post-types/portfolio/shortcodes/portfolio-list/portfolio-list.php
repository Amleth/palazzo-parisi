...
namespace MuseaCore\CPT\Shortcodes\Portfolio;
...
class PortfolioList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map( array(
					'name'     => esc_html__( 'Portfolio List', 'musea-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Portfolio List Template', 'musea-core' ),
							'value'       => array(
								esc_html__( 'Gallery', 'musea-core' ) => 'gallery',
								esc_html__( 'Masonry', 'musea-core' ) => 'masonry'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							...
							'heading'    => esc_html__( 'Click Behavior', 'musea-core' ),
							'value'      => array(
								esc_html__( 'Open portfolio single page on click', 'musea-core' )   => '',
								esc_html__( 'Open gallery in Pretty Photo on click', 'musea-core' ) => 'gallery'
							)
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Number of Portfolios Per Page', 'musea-core' ),
							'description' => esc_html__( 'Set number of items for your portfolio list. Enter -1 to show all.', 'musea-core' ),
							'value'       => '-1'
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'image_proportions',
							'heading'     => esc_html__( 'Image Proportions', 'musea-core' ),
							'value'       => array(
								esc_html__( 'Original', 'musea-core' )  => 'full',
								esc_html__( 'Square', 'musea-core' )    => 'square',
								esc_html__( 'Landscape', 'musea-core' ) => 'landscape',
								esc_html__( 'Portrait', 'musea-core' )  => 'portrait',
								esc_html__( 'Medium', 'musea-core' )    => 'medium',
								esc_html__( 'Large', 'musea-core' )     => 'large',
								esc_html__( 'Custom', 'musea-core' )    => 'custom'
							),
							'description' => esc_html__( 'Set image proportions for your portfolio list.', 'musea-core' ),
							'dependency'  => array( 'element' => 'type', 'value' => array( 'gallery' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'custom_image_width',
							'heading'     => esc_html__( 'Custom Image Width', 'musea-core' ),
							'description' => esc_html__( 'Enter image width in px', 'musea-core' ),
							'dependency'  => array( 'element' => 'image_proportions', 'value' => 'custom' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'custom_image_height',
							'heading'     => esc_html__( 'Custom Image Height', 'musea-core' ),
							'description' => esc_html__( 'Enter image height in px', 'musea-core' ),
							'dependency'  => array( 'element' => 'image_proportions', 'value' => 'custom' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'enable_fixed_proportions',
							'heading'     => esc_html__( 'Enable Fixed Image Proportions', 'musea-core' ),
							'value'       => array_flip( musea_elated_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Set predefined image proportions for your masonry portfolio list. This option will apply image proportions you set in Portfolio Single page - dimensions for masonry option.', 'musea-core' ),
						...
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'category',
							'heading'     => esc_html__( 'One-Category Portfolio List', 'musea-core' ),
							'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'musea-core' )
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'selected_projects',
							'heading'     => esc_html__( 'Show Only Projects with Listed IDs', 'musea-core' ),
							'settings'    => array(
								'multiple'      => true,
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'Delimit ID numbers by comma (leave empty for all)', 'musea-core' )
						),
						array(
							'type'        => 'autocomplete',
							'param_name'  => 'tag',
							'heading'     => esc_html__( 'One-Tag Portfolio List', 'musea-core' ),
							'description' => esc_html__( 'Enter one tag slug (leave empty for showing all tags)', 'musea-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'orderby',
							'heading'     => esc_html__( 'Order By', 'musea-core' ),
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'order',
							'heading'     => esc_html__( 'Order', 'musea-core' ),
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Standard - Shader', 'musea-core' )                 => 'standard-shader',
								esc_html__( 'Standard - Switch Featured Images', 'musea-core' ) => 'standard-switch-images',
								esc_html__( 'Gallery - Overlay', 'musea-core' )                 => 'gallery-overlay',
								esc_html__( 'Gallery - Slide From Image Bottom', 'musea-core' ) => 'gallery-slide-from-image-bottom'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Top Margin (px or %)', 'musea-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Bottom Margin (px or %)', 'musea-core' ),
							'dependency' => array( 'element' => 'item_style', 'value' => array( 'standard-shader', 'standard-switch-images' ) ),
							'group'      => esc_html__( 'Content Layout', 'musea-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Title', 'musea-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Title Text Transform', 'musea-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Enable Category', 'musea-core' ),
							'value'      => array_flip( musea_elated_get_yes_no_select_array( false, true ) ),
							'group'      => esc_html__( 'Content Layout', 'musea-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Number of Images', 'musea-core' ),
							'value'      => array_flip( musea_elated_get_yes_no_select_array( false, true ) ),
							'dependency' => array( 'element' => 'type', 'value' => array( 'gallery' ) ),
							'group'      => esc_html__( 'Content Layout', 'musea-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Enable Excerpt', 'musea-core' ),
							'value'      => array_flip( musea_elated_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Content Layout', 'musea-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Excerpt Length', 'musea-core' ),
							'description' => esc_html__( 'Number of characters', 'musea-core' ),
						...
						array(
							'type'       => 'dropdown',
							'param_name' => 'filter',
							'heading'    => esc_html__( 'Enable Category Filter', 'musea-core' ),
							'value'      => array_flip( musea_elated_get_yes_no_select_array( false ) ),
							'group'      => esc_html__( 'Additional Features', 'musea-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Order By', 'musea-core' ),
							'value'      => array(
								esc_html__( 'Name', 'musea-core' )  => 'name',
								esc_html__( 'Count', 'musea-core' ) => 'count',
								esc_html__( 'Id', 'musea-core' )    => 'id',
								esc_html__( 'Slug', 'musea-core' )  => 'slug'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Filter Text Transform', 'musea-core' ),
							'value'      => array_flip( musea_elated_get_text_transform_array( true ) ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'musea-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Filter Bottom Margin (px or %)', 'musea-core' ),
							'dependency' => array( 'element' => 'filter', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Additional Features', 'musea-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Enable Article Animation', 'musea-core' ),
							'value'       => array_flip( musea_elated_get_yes_no_select_array( false ) ),
							'description' => esc_html__( 'Enabling this option you will enable appears animation for your portfolio list items', 'musea-core' ),
							'group'       => esc_html__( 'Additional Features', 'musea-core' )
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = musea_core_get_cpt_shortcode_module_template_part( 'portfolio', 'portfolio-list', 'portfolio-holder', $params['type'], $params, $additional_params );
	...
	public function getImageSize( $params ) {
		...
		if ( ! empty( $params['image_proportions'] ) && $params['type'] == 'gallery' ) {
			...
			switch ( $image_size ) {
				case 'landscape':
					$thumb_size = 'musea_elated_image_landscape';
					break;
				case 'portrait':
					$thumb_size = 'musea_elated_image_portrait';
					break;
				case 'square':
					$thumb_size = 'musea_elated_image_square';
					break;
				case 'medium':
					$thumb_size = 'medium';
					break;
		...
		if ( $params['type'] == 'masonry' && $params['enable_fixed_proportions'] === 'yes' ) {
			...
			switch ( $fixed_image_size ) {
				...
				case 'large-width-height':
					$thumb_size = 'musea_elated_image_huge';
					break;
				default :
					$thumb_size = 'full';
					break;
	...
	public function getStandardContentStyles( $params ) {
		...
		if ( ! empty( $margin_top ) ) {
			if ( musea_elated_string_ends_with( $margin_top, '%' ) || musea_elated_string_ends_with( $margin_top, 'px' ) ) {
		...
		if ( ! empty( $margin_bottom ) ) {
			if ( musea_elated_string_ends_with( $margin_bottom, '%' ) || musea_elated_string_ends_with( $margin_bottom, 'px' ) ) {
	...
	public function getFilterHolderStyles( $params ) {
		...
		if ( ! empty( $params['filter_bottom_margin'] ) ) {
			...
			if ( musea_elated_string_ends_with( $margin, '%' ) || musea_elated_string_ends_with( $margin, 'px' ) ) {
				...
				$styles[] = 'margin-bottom: ' . musea_elated_filter_px( $margin ) . 'px';
			}
		}
	...
	public function getItemLink() {
		...
		return apply_filters( 'musea_elated_filter_portfolio_external_link', $portfolio_link );
	}
	...
	public function getItemLinkTarget() {
		...
		return apply_filters( 'musea_elated_filter_portfolio_external_link_target', $portfolio_link_target );
	}
	...
	public function portfolioCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['portfolio_category_title'] ) > 0 ) ? esc_html__( 'Category', 'musea-core' ) . ': ' . $value['portfolio_category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_category ) ) {
				...
				if ( ! empty( $portfolio_category_title ) ) {
					$portfolio_category_title_display = esc_html__( 'Category', 'musea-core' ) . ': ' . $portfolio_category_title;
				}
	...
	public function portfolioIdAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data          = array();
				$data['value'] = $value['id'];
				$data['label'] = esc_html__( 'Id', 'musea-core' ) . ': ' . $value['id'] . ( ( strlen( $value['title'] ) > 0 ) ? ' - ' . esc_html__( 'Title', 'musea-core' ) . ': ' . $value['title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( ! is_wp_error( $portfolio ) ) {
				...
				if ( ! empty( $portfolio_title ) ) {
					$portfolio_title_display = ' - ' . esc_html__( 'Title', 'musea-core' ) . ': ' . $portfolio_title;
				}
				
				$portfolio_id_display = esc_html__( 'Id', 'musea-core' ) . ': ' . $portfolio_id;
	...
	public function portfolioTagAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				$data          = array();
				$data['value'] = $value['slug'];
				$data['label'] = ( ( strlen( $value['portfolio_tag_title'] ) > 0 ) ? esc_html__( 'Tag', 'musea-core' ) . ': ' . $value['portfolio_tag_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $portfolio_tag ) ) {
				...
				if ( ! empty( $portfolio_tag_title ) ) {
					$portfolio_tag_title_display = esc_html__( 'Tag', 'musea-core' ) . ': ' . $portfolio_tag_title;
				}
