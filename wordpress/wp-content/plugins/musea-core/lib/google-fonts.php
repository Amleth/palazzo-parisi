<?php
if ( ! function_exists( 'musea_elated_init_google_fonts_array' ) ) {
    function musea_elated_init_google_fonts_array() {
...
';
        ...
        $musea_elated_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'musea_elated_init_google_fonts_array');
}