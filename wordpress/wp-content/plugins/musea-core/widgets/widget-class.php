 ...
 *
 * Class MuseaCoreClassWidget
 */
abstract class MuseaCoreClassWidget extends WP_Widget {
    /**
    ...
    public function form($instance) {
        if(is_array($this->params) && count($this->params)) {
	                ...
	                case 'image': ?>
		                <div class="eltdf-user-image-field">
			                ...
			                <p>
				                ...
				                <input type="button" class="button button-secondary eltdf-user-media-remove" name="eltdf-user-media-remove" value="<?php esc_attr_e( 'Remove Image', 'musea' ); ?>"/>
			                </p>
		                </div>
		                <?php
		                break;
            ...
            <p><?php esc_html_e('There are no options for this widget.', 'musea-core'); ?></p>
        <?php }
    }
